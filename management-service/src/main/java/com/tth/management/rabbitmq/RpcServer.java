...
import com.tth.management.controller.EventController;
        ...
        try {
            ...
            if (request != null) {
                ...
                switch (request.getRequestMethod()) {
                    case "GET":
                        if ("/management/report".equalsIgnoreCase(requestPath)) {
                        ...
                        } else if ("/management/report/line".equalsIgnoreCase(requestPath)) {
